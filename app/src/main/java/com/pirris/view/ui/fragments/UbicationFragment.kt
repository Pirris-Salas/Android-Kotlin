...
class UbicationFragment : Fragment(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener{
    ...
    override fun onMapReady(googleMap: GoogleMap?) {
        val ubication = Ubication() //Instanciamos la clase Ubication, la cual tiene los datos asignados manualmente
        ...
        //Damos el estilo importado al mapa
        googleMap?.setMapStyle(MapStyleOptions.loadRawResourceStyle(context, R.raw.custom_map_night))
    }
